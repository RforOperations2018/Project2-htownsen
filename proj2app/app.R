...
server <- function(input, output) {
  pghLoad <- reactive({
    # Build URL Query
    url <- URLencode(paste0("https://services1.arcgis.com/YZCmUqbcsUpOKfj7/arcgis/rest/services/PGHWebNeighborhoods/FeatureServer/0/query?where=HOOD+%3D+%27", input$hoodSelect,
